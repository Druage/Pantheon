...
class XmlLibrary(QObject): #Not sure if I even need this anymore
...
def xmlwriter(data): #xmlwriter() is loaded automatically after scan is run
        ...
        for key in data: #removes extensions for filenames for key values
            ...
            while True:          
                if PLATFORM == "win32":
                    ...
                    if ".sfc" in  extension or ".smc" in extension: #Adds system data to xml
